...
def score_seasonality(pair: str = "EURUSD") -> float:
    ...
    seasonality_maps = {
        ...
        # EURJPY: EUR silnější koncem roku (risk-off), JPY silnější v březnu/dubnu (repatriace)
        "EURJPY": {
            1: -1.0, 2: -1.0, 3: -3.0, 4: -2.0, 5: 0.0, 6: 1.0,
            7: 2.0, 8: 2.0, 9: 1.0, 10: -1.0, 11: -2.0, 12: -1.0
        },
        # XAUUSD: Zlato silnější v lednu (safe haven), únoru (šperky - čínský nový rok),
        # září (indická svatební sezóna), slabší v březnu a červnu.
        "XAUUSD": {
            1: 3.0, 2: 2.0, 3: -2.0, 4: 0.0, 5: -1.0, 6: -2.0,
            7: 0.0, 8: 1.0, 9: 2.0, 10: 1.0, 11: -1.0, 12: 2.0
        },
    }
    
    pair_map = seasonality_maps.get(pair)
    if pair_map is None:
        # Pro neznámé páry vracíme 0.0 (neutrální) — nechceme vnucovat nesprávnou sezónnost
        return 0.0

...
CREATE TABLE IF NOT EXISTS predictions (
  ...
  -- Scénářová analýza (přidáno v2)
  scenario_beat       FLOAT,              -- skóre pokud všechny zprávy překonají oček.
  scenario_miss       FLOAT,              -- skóre pokud všechny zprávy zklamou
  mean_reversion_applied BOOLEAN DEFAULT true, -- false = pozastaveno před key eventem
